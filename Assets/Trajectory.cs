    ...
    void Update()
    {
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            if (circleCastHit2D.collider != null &&
                circleCastHit2D.collider.GetComponent<BallControl2>() == null)
            {
                ...
                if (circleCastHit2D.collider.GetComponent<BallControl2>() == null)
                {
                    ...
                    if (outDot > -1 && outDot < 1)
                    {
                        ...
                        DottedLine.DottedLine.Instance.DrawDottedLine(
                            offsetHitPoint,
                            offsetHitPoint + outVector * 100.0f);
